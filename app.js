...
form.addEventListener("submit", async (e) => {
  ...
  page.drawText("RECEPCIÓN DE EQUIPO Y DIAGNÓSTICO", { x: 155, y: height - 80, size: 12, font: fontBold });
  ...
  page.drawText(folio, { x: 495, y: height - 105, size: 14, font: fontBold, color: rgb(1, 0, 0) });
